...
import PriyatamLibraryBanner from "./PriyatamLibraryBanner.png";
            ...
            <div className="max-w-7xl mx-auto print-container" ref={printRef}>
              ...
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                <div className="flex justify-center mb-6 no-print">
                  <img src={PriyatamLibraryBanner} alt="SDM Library Logo" className="max-w-[250px]" />
                </div>

                <img
                  src={PriyatamLibraryBanner}
                ...
                <div className="flex justify-between items-start mb-8 border-b pb-8">
                  ...
                  <div>
                    {student.profileImageUrl ? (
                      <div>
                        <h2 className="text-lg font-medium text-gray-700 mb-2">Profile Image</h2>
                        <img 
                      ...
                      <div>
                         <h2 className="text-lg font-medium text-gray-700 mb-2">Profile Image</h2>
                         <div className="w-32 h-32 rounded-full bg-gray-100 flex items-center justify-center text-gray-400 border-2">No Image</div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex gap-4 text-right">
                    {student.aadhaarFrontUrl && (
                      <div>
                        <h2 className="text-lg font-medium text-gray-700 mb-2">Aadhaar Front</h2>
                        <div className="w-48 p-1 border rounded-lg bg-gray-50 shadow-sm">
                            <img 
                    ...
                    {student.aadhaarBackUrl && (
                      <div>
                        <h2 className="text-lg font-medium text-gray-700 mb-2">Aadhaar Back</h2>
                        <div className="w-48 p-1 border rounded-lg bg-gray-50 shadow-sm">
                            <img 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {student.totalFee != null ? `Rs. ${student.totalFee.toFixed(2)}` : 'N/A'}
                    </p>
                  </div>
                  <div>
                    <h2 className="text-lg font-medium">Amount Paid</h2>
                    <p className="text-gray-600">
                      {student.amountPaid != null ? `Rs. ${student.amountPaid.toFixed(2)}` : 'N/A'}
                    </p>
                  </div>
                   <div>
                    <h2 className="text-lg font-medium">Discount</h2>
                    <p className="text-gray-600">
                      {student.discount != null ? `Rs. ${student.discount.toFixed(2)}` : 'N/A'}
                    </p>
                  </div>
                  <div>
                    <h2 className="text-lg font-medium">Due Amount</h2>
                    <p className="text-gray-600">
                      {student.dueAmount != null ? `Rs. ${student.dueAmount.toFixed(2)}` : 'N/A'}
                    </p>
                  </div>
                  <div>
                    <h2 className="text-lg font-medium">Cash Payment</h2>
                    <p className="text-gray-600">
                      {student.cash != null ? `Rs. ${student.cash.toFixed(2)}` : 'N/A'}
                    </p>
                  </div>
                  <div>
                    <h2 className="text-lg font-medium">Online Payment</h2>
                    <p className="text-gray-600">
                      {student.online != null ? `Rs. ${student.online.toFixed(2)}` : 'N/A'}
                    </p>
                  </div>
                  <div>
                    <h2 className="text-lg font-medium">Security Money</h2>
                    <p className="text-gray-600">
                      {student.securityMoney != null ? `Rs. ${student.securityMoney.toFixed(2)}` : 'N/A'}
                    </p>
                  </div>
                  <div>
